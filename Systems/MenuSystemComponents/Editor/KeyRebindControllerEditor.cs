...
namespace Cobra.GUI
{
    ...
    /// </summary>
    [UnityEditor.CustomEditor(typeof(KeyRebindController))]
    public class KeyRebindControllerEditor : Editor
    {
        protected void OnEnable()
        {
            ...
            m_CancelThroughControl = serializedObject.FindProperty("m_CancelThrough");
            m_UpdateBindingUIEventProperty = serializedObject.FindProperty("m_RebindUpdateEvent");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_CancelThroughControl);
            }
        ...
        private SerializedProperty m_CancelThroughControl;
